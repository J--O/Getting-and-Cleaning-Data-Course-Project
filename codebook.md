This code book only describes the modifications and updates to the codebooks already available to you with the data obtained from
"https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
It indicates all the variables and summaries I calculated, along with units, and any other relevant information.
